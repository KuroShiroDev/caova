...
export const Header = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full bg-[#0c457c] bg-opacity-90 backdrop-blur-md flex justify-between items-center px-6 md:px-10 py-4 text-primary-foreground shadow-lg z-50">
