    ...
    <div className="flex flex-col gap-2 items-center my-14 md:my-24 w-full">
      <Form {...form}>
        <form
          ...
          <CustomTextInput
            form={form}
            label="Rentabilidad de la renta anual*"
            name="rentalYieldsAnnualCash"
            type="number"
          />
          <CustomTextInput
            form={form}
          ...
          <CustomTextInput
            form={form}
            label="Costo de equipos y prueba"
            name="basicEquipmentAndTestingCost"
            type="number"
          />
          <CustomTextInput form={form} label="Costo legal" name="legalCost" type="number" />
          <CustomTextInput
            form={form}
            label="Costo de certificado SN y RC"
            name="cetificatesSNandRCost"
            type="number"
          />
          <CustomTextInput
            form={form}
            label="Costo de titulo de estudios"
            name="studyTitleCost"
            type="number"
          />
          <CustomTextInput
          ...
          <CustomTextInput
            form={form}
            label="Costo de servicios de cuenta"
            name="accountServicesCost"
            type="number"
          />
          ...
          <CustomTextInput
            form={form}
            label="Costo de busqueda y publicidad"
            name="searchAndAdvertisingFee"
            type="number"
          />
